...
if _TYPE_CHECKING:
    from openspace.application import OpenSpace as OpenSpace, OpenSpaceConfig as OpenSpaceConfig
    from openspace.agents.grounding_agent import GroundingAgent as GroundingAgent
...
_attr_to_module: _Dict[str, str] = {
    # Main API
    "OpenSpace": "openspace.application",
    "OpenSpaceConfig": "openspace.application",

    # Core Components
    "GroundingAgent": "openspace.agents.grounding_agent",
